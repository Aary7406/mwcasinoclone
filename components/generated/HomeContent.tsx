        ...
        <div className="ng-c-576795117 partners-list">
          <ul className="ng-c-576795117">
            <li className="ng-c-576795117">
              <img className="ng-c-576795117" alt="FC BAYERN MUNICH" loading="lazy" src="/placeholders/fc-bayern-munich.svg" />
          ...
          <ul className="ng-c-576795117">
            <li className="ng-c-576795117">
              <img className="ng-c-576795117" alt="BUNDESLIGA" loading="lazy" src="/placeholders/bundesliga.svg" />
              <p className="ng-c-576795117">
